...
# ....................................................
# 2. Download data ----
# public schools -- updated public schools as of 07/20 are from 2020-2021 school year
download.file(url = "https://nces.ed.gov/programs/edge/data/EDGE_GEOCODE_PUBLICSCH_2021.zip",
              destfile = "tempdata/public_schools.zip") # public school data file 
unzip(zipfile = "tempdata/public_schools.zip", exdir = "tempdata/public_schools")

pubschools_sf = st_read(dsn = "tempdata/public_schools/EDGE_GEOCODE_PUBLICSCH_2021/Shapefiles_SCH/EDGE_GEOCODE_PUBLICSCH_2021.shp")
# geometry type:  POINT
# dimension:      XY
# epsg (SRID):    4269
# proj4string:    +proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_defs

# private schools -- updated private schools as of 07/20 are from 2019-2020 school year
...
privschools_sf = st_read(dsn = "tempdata/private_schools/EDGE_GEOCODE_PRIVATESCH_1920.shp")
# geometry type:  POINT
# dimension:      XY
# epsg (SRID):    4269
# proj4string:    +proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_defs
