...
pubschools_sf = st_read(dsn = "data/tempdata/public_schools/Shapefiles_SCH/EDGE_GEOCODE_PUBLICSCH_2223.shp")
# Simple feature collection with 102268 features and 25 fields
# Geometry type: POINT
# Dimension:     XY
...
privschools_sf = st_read(dsn = "data/tempdata/private_schools/EDGE_GEOCODE_PRIVATESCH_2122/EDGE_GEOCODE_PRIVATESCH_2122.shp")
# Simple feature collection with 22345 features and 23 fields
# Geometry type: POINT
# Dimension:     XY
# Bounding box:  xmin: -159.713 ymin: 19.49081 xmax: -67.38874 ymax: 64.87414
# Geodetic CRS:  NAD83
...
sabs_sf <- st_read("data/tempdata/SABS_1516/SABS_1516.shp")
