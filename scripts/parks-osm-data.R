...
# ....................................................
# Save as geojson
st_write(parks, dsn = paste0(filepath_data, "parks_OSM_sf.geojson"), driver = "GeoJSON", delete_dsn = TRUE, factorsAsCharacter = TRUE) 

st_crs(parks)

# Remove vars from environment
rm(list = ls(pattern = "^(historic|parkvar|region_)"))
rm(list = setdiff(ls(pattern = "^parks"), "parks"))
